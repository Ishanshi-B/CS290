...
{
  // creating a stack and stack->list
...
{
  // checking is the list is empty with a custom program
...
{
  // custom list_top to check the top of the list
