...
/*
 * Custom function that checks if the list is empty by checking if the head is null or not
 * 
 * Params:
 *   list - the linked list to be reversed.  May not be NULL.  When this
 *     function returns this should contain the reversed list.
...
/*
 * Custom function that checks if the list is NULL. If yes then return NULL, if not then return the value present in the head
 * 
 * Params:
 *   list - the linked list to be reversed.  May not be NULL.  When this
 *     function returns this should contain the reversed list.
...
/*
 * Custom function that pops/removes the head value. This is done simply by setting the empty 
 * linked list as the head. Then setting the next value after head as head.  
 * Params:
 *   list - the linked list to be reversed.  May not be NULL.  When this
 *     function returns this should contain the reversed list.
 */
